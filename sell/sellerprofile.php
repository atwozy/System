...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand" href="../index.php"><h1 class="ti-logo"><img class="logo" src="../assets/img/logos/logo1.png"> Sining</h1></a>
...
<div class="upper-con">
   <div class="container1">
      ...
      <div class="profile">
         ...
         ?>
         <h3 class="p1 seller-name"><?php echo $fetch['name']; ?>
...
<!-- SEARCH -->
    ...
    <tr>
      <td class="gray-box add"><a href="upload.php" class="btn"><button><img src="../assets/img/add-btn.png">Add Products</button></a></td>
   ...
   <?php
      ...
      $rows = mysqli_query($conn, "SELECT * FROM sining_artists INNER JOIN sining_artworks ON sining_artists.id = sining_artworks.artistid WHERE sining_artworks.artistid='$user_id' AND title LIKE '%$title%' ORDER BY sining_artworks.title DESC");
      ?>
...
?>
      ...
      <?php foreach ($rows as $row) : ?>
        ...
        <td class="title-con2"><?php echo $row["title"]; ?></td>
        </tr>
    <tr>
    <td class="loc-con1">Location</td>
        <td class="loc-con2"><?php echo $row["location"]; ?></td>
        </tr>
    <tr>
    <td class="price-con1">Price</td>
        ...
        <td colspan="2" class="image"> <img src="../uploaded_img/<?php echo $row["image"]; ?>" width = 300> </td>
        </tr>
    <tr>
<!-- START UPDATE-->
...
?>   
      ...
      <tr >
        <td style="font-size:3vw" colspan="2" class="space-top"><?php echo $category= $_POST["category"];?></td>
      </tr>
      <?php foreach ($rows as $row) : ?>
