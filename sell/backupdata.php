...
<html lang="en" dir="ltr">
  ...
  <body>
    <table cellspacing = 0 cellpadding = 10>
      ...
      $rows = mysqli_query($conn,"SELECT * FROM sining_artists INNER JOIN sining_artworks ON sining_artists.id = sining_artworks.artid WHERE category='$category'");  
      ...
      <tr>
        ...
        <td> <img src="img/<?php echo $row["image"]; ?>" width = 200> </td>
      </tr>
      <?php endforeach; ?>
    </table>
    <br>
