...
$rows = mysqli_query($conn, "SELECT * FROM sining_artists INNER JOIN artworks_archive ON sining_artists.id = artworks_archive.artistid WHERE artworks_archive.artistid='$user_id' ORDER BY artworks_archive.title ASC");  
?>
      ...
      <tr>
        ...
        <td class="location1"><?php echo $row["location"]; ?></td>
        </tr><tr>
