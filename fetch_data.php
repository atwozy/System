...
if(isset($_POST["action"]))
{
	...
	if($total_row > 0)
	{
			...
			<div class="img-con-inner col-sm-4 col-lg-3 col-md-3">
				...
				<button class="img-btn" type="submit" name="artid" value="'.$row['artId'].'">
					<img src="artworks/'. $row['artImage'] .'" alt="" class="img-responsive">
				</button><br><br>
				...
				<p class="text art-title" align="center">
					...
					<table>
						...
						<tr>
							<td class="there">Category</td>
							<td class="here">'.$row['artCategory'] .'</td>
						</tr>
					</table>
					</div>
				</div>
...
<style>
	...
	.img-con .img-con-inner .image-box{
		background-color: #ececec;
		box-shadow: 1px 0px 5px 0px rgba(0, 0, 0, 0.5);
	}
	/* .img-con .img-con-inner .image-box img{
		border: 1px solid yellow;
	} */
	.img-con .img-con-inner .image-box .img-btn{
		border: none;
		background: white;
		padding: 10px;
	}
	.img-con .img-con-inner .image-box .art-title{
		color: #000;
		font-size: larger;
	}
	.img-con .img-con-inner .image-box .text-box{
		border: 1px solid red;
		border: 10px solid white;
		padding: 5px;
	}
	.img-con .img-con-inner .image-box .text-box table td{
		padding-left: 10px;
	}
	.img-con .img-con-inner .image-box .text-box table .here{
		border-left: 1px solid #cecece;
	}
	.img-con .img-con-inner .image-box .text-box table .there{
		padding-right: 10px;
	}
</style>