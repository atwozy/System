    ...
    <body onload="zoom()" id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand" href="#page-top"><h1 class="ti-logo">Sining</h1></a>
                ...
                <div class="search collapse navbar-collapse" id="navbarResponsive">
                    <ul class="menu-bar navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="newsfeed.php">Editorial</a></li>
                ...
                <div class="account-btn">
                        ...
                        <a href="privacy.php" id="account-lbl">Privacy Settings</a><br><br>
