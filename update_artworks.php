...
if(isset($_POST['update_artworks'])){
   ...
   mysqli_query($conn, "UPDATE `sining_artworks` SET artTitle ='$update_title', artCategory ='$update_category', artPrice = '$update_price' WHERE artId =' ". $_GET['updateid']." ' ") or die('query failed');
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <span>Category :</span>
            <input type="text" name="update_category" value="<?php echo $fetch['artCategory']; ?>" class="box">
            <span>Price :</span>
