...
$rows = mysqli_query($conn, "SELECT * FROM sining_artists INNER JOIN artworks_archive ON sining_artists.artistId = artworks_archive.artistId WHERE artworks_archive.artistid='$user_id' ORDER BY artworks_archive.artTitle ASC");  
?>
      ...
      <tr>
        ...
        <td class="title1">"<?php echo $row["artTitle"]; ?>"</td>
        </tr><tr>
          <td class="location">Location</td>
        <td class="location1"><?php echo $row["artistLocation"]; ?></td>
        </tr><tr>
        ...
        <td class="image" colspan="2"> <img src=" uploaded_img/<?php echo $row["artImage"]; ?>" width = 200> </td>
        </tr><tr>
