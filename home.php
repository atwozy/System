        ...
        <div class="row">
            ...
            <div class="col-md-3">                				
                ...
                <div class="list-group"><br>
                    ...
                    $query = $conn->query("SELECT DISTINCT(artCategory) FROM sining_artworks WHERE product_status = '1' ORDER BY artId DESC");
                    
                    foreach($query as $row)
                    {
                    ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector category" value="<?php echo $row['artCategory']; ?>"  > <?php echo $row['artCategory']; ?></label>
                    </div>
                    <?php
                    }
